...
void cbr::CbrPlotControls::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (CbrPlotControls::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CbrPlotControls::currentChanged)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (CbrPlotControls::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CbrPlotControls::gridLevelChanged)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject cbr::CbrPlotControls::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_cbr__CbrPlotControls.data,
      qt_meta_data_cbr__CbrPlotControls,  qt_static_metacall, nullptr, nullptr}
};
