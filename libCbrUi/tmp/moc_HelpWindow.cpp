...
QT_MOC_LITERAL(1, 11, 14), // "doSaveAsAction"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 12) // "doHomeAction"

    },
    "HelpWindow\0doSaveAsAction\0\0doHomeAction"
};
...
void *HelpWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "Ui_HelpWindow"))
        return static_cast< Ui_HelpWindow*>(this);
