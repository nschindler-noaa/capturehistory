...
struct qt_meta_stringdata_cbr__NavPanelView_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_cbr__NavPanelView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_cbr__NavPanelView_t qt_meta_stringdata_cbr__NavPanelView = {
    {
QT_MOC_LITERAL(0, 0, 17) // "cbr::NavPanelView"
...
QT_INIT_METAOBJECT const QMetaObject cbr::NavPanelView::staticMetaObject = { {
    &QTreeView::staticMetaObject,
    qt_meta_stringdata_cbr__NavPanelView.data,
    qt_meta_data_cbr__NavPanelView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *cbr::NavPanelView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cbr__NavPanelView.stringdata0))
