...
void TextWindowSimple::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TextWindowSimple *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (TextWindowSimple::*)(bool );
...
QT_INIT_METAOBJECT const QMetaObject TextWindowSimple::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_TextWindowSimple.data,
    qt_meta_data_TextWindowSimple,
    qt_static_metacall,
    nullptr,
    nullptr
} };
