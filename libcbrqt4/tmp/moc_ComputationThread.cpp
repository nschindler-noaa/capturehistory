...
void ComputationThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ComputationThread::*_t)(bool );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ComputationThread::cancelEnabled)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ComputationThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ComputationThread.data,
      qt_meta_data_ComputationThread,  qt_static_metacall, nullptr, nullptr}
};
