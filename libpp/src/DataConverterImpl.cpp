...
void DataConverterImpl::refresh() {
	...
	QString dataDir = settings.getValue( PitProSettings::DataDir ).c_str();
...
void DataConverterImpl::obsFileChanged() {
	...
	PitProSettings& settings = PitProSettings::getInstance();
	QString obsSuffix = settings.getValue( PitProSettings::ObsSuffix ).c_str();
...
void DataConverterImpl::tagFileChanged() {
	...
	PitProSettings& settings = PitProSettings::getInstance();
	QString tagSuffix = settings.getValue( PitProSettings::TagSuffix ).c_str();
