...
void DataConverterImpl::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DataConverterImpl::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DataConverterImpl::dataConverted)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DataConverterImpl::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_DataConverterImpl.data,
      qt_meta_data_DataConverterImpl,  qt_static_metacall, nullptr, nullptr}
};
