...
struct qt_meta_stringdata_PPComputationThread_t {
    QByteArrayData data[1];
    char stringdata0[20];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PPComputationThread_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PPComputationThread_t qt_meta_stringdata_PPComputationThread = {
    {
QT_MOC_LITERAL(0, 0, 19) // "PPComputationThread"
...
QT_INIT_METAOBJECT const QMetaObject PPComputationThread::staticMetaObject = { {
    &ComputationThread::staticMetaObject,
    qt_meta_stringdata_PPComputationThread.data,
    qt_meta_data_PPComputationThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PPComputationThread::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PPComputationThread.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "PPOutputMaker"))
        return static_cast< PPOutputMaker*>(this);
